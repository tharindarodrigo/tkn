...
@section('content')
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall"
        ...
        <div class="container g-color-white text-center g-py-150">
            ...
            <h3 class="h1 text-uppercase mb-0">Unify is a clean and fully responsive theme</h3>
        </div>
        {{-- Promo Block Content --}}
    </section>
    {{-- End Promo Block --}}
    <section class="container g-pt-100 g-pb-50">
        <div class="row justify-content-center g-mb-60">
            <div class="col-lg-7">
                ...
                <div class="text-center">
                    <h2 class="h3 g-color-black text-uppercase mb-2">We are Unify</h2>
                    <div class="d-inline-block g-width-35 g-height-2 g-bg-primary mb-2"></div>
                    <p class="mb-0">We are a creative studio focusing on culture, luxury, editorial &amp; art. Somewhere
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="mb-5">
                    <p class="g-mb-30">As creatives, it's important that we strive to do work outside of obligation.
                        This lets us stay ahead of the curve for our clients and internal projects.</p>
                    <div class="row">
                        <div class="col-sm-6">
                            <ul class="list-unstyled g-font-size-13 mb-0">
                                <li class="d-flex mb-3">
                                    <i class="g-color-primary g-mt-5 g-mr-10 icon-check"></i> Jacks of all. Experts in
                                    all.
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="g-color-primary g-mt-5 g-mr-10 icon-check"></i> It's good to virtually
                                    meet you.
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="g-color-primary g-mt-5 g-mr-10 icon-check"></i> A crew of creative doers.
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="g-color-primary g-mt-5 g-mr-10 icon-check"></i> Let's create something
                                    great.
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-6">
                            <ul class="list-unstyled g-font-size-13 mb-0">
                                <li class="d-flex mb-3">
                                    <i class="g-color-primary g-mt-5 g-mr-10 icon-check"></i> We're accepting projects
                                    today.
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="g-color-primary g-mt-5 g-mr-10 icon-check"></i> Finding your perfect plan.
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="g-color-primary g-mt-5 g-mr-10 icon-check"></i> Examples of branding
                                    projects.
                                </li>
                                <li class="d-flex mb-3">
                                    <i class="g-color-primary g-mt-5 g-mr-10 icon-check"></i> Your brand has a story to
                                    tell.
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
               ...
               <i class="icon-education-087 u-line-icon-pro"></i>
                        ...
                        <p class="g-color-gray-dark-v4">We strive to embrace and drive change in our industry which
                            allows us to keep our clients relevant and ready to adapt.</p>
                    </div>
                    {{-- End Icon Blocks --}}
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                ...
                <article class="u-shadow-v21 g-bg-size-cover g-bg-pos-bottom-center text-center"
                         style="background-image: url(../../assets/img-temp/900x600/img7.jpg);">
        ...
        <div class="container g-pt-100 g-pb-70">
            ...
            <div class="row g-mb-30">
                <div class="col-lg-6 g-mb-30">
                    <div class="mb-5">
                        <p>As creatives, it's important that we strive to do work outside of obligation. This lets us
                            stay ahead of the curve for our clients and internal projects.</p>
                        <p>At the end of the day, it's important to not let being busy distract us from having fun.
                            Smiling, laughing, and hanging helps us work together to achieve this. It’s important to
                            stay detail oriented with every project we tackle.</p>
                    </div>
                    <a class="btn btn-md u-btn-outline-black g-font-size-default rounded-0 g-py-10 mr-2" href="#!">Explore
                        More</a>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="js-hr-progress-bar progress g-height-2 rounded-0">
                        <div class="js-hr-progress-bar-indicator progress-bar" role="progressbar" style="width: 69%;"
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 g-mb-30">
                <div class="text-center u-block-hover">
                    ...
                    <figure class="u-block-hover g-mb-25">
                        {{-- Figure Image --}}
                        <img class="w-100" src="../../assets/img-temp/400x550/img1.jpg"
                             alt="Image Description"> {{-- End Figure Image --}} {{-- Figure Caption --}}
                        <figcaption
                                class="u-block-hover__additional--fade g-bg-primary-opacity-0_9 g-flex-middle g-px-10">
                            <q class="u-quote-v1 g-flex-middle-item g-color-white g-font-weight-700 g-font-size-16 text-uppercase">changing
                                your mind and changing world</q> {{-- Figure Social Icons --}}
            ...
            <div class="col-lg-3 col-sm-6 g-mb-30">
                <div class="text-center u-block-hover">
                    ...
                    <figure class="u-block-hover g-mb-25">
                        {{-- Figure Image --}}
                        <img class="w-100" src="../../assets/img-temp/400x550/img2.jpg"
                             alt="Image Description"> {{-- End Figure Image --}} {{-- Figure Caption --}}
                        <figcaption
                                class="u-block-hover__additional--fade g-bg-primary-opacity-0_9 g-flex-middle g-px-10">
                            <q class="u-quote-v1 g-flex-middle-item g-color-white g-font-weight-700 g-font-size-16 text-uppercase">changing
            ...
            <div class="col-lg-3 col-sm-6 g-mb-30">
                <div class="text-center u-block-hover">
                    ...
                    <figure class="u-block-hover g-mb-25">
                        {{-- Figure Image --}}
                        <img class="w-100" src="../../assets/img-temp/400x550/img3.jpg"
                             alt="Image Description"> {{-- End Figure Image --}} {{-- Figure Caption --}}
                        <figcaption
                                class="u-block-hover__additional--fade g-bg-primary-opacity-0_9 g-flex-middle g-px-10">
                            <q class="u-quote-v1 g-flex-middle-item g-color-white g-font-weight-700 g-font-size-16 text-uppercase">changing
            ...
            <div class="col-lg-3 col-sm-6 g-mb-30">
                <div class="text-center u-block-hover">
                    ...
                    <figure class="u-block-hover g-mb-25">
                        {{-- Figure Image --}}
                        <img class="w-100" src="../../assets/img-temp/400x550/img4.jpg"
                             alt="Image Description"> {{-- End Figure Image --}} {{-- Figure Caption --}}
                        <figcaption
                                class="u-block-hover__additional--fade g-bg-primary-opacity-0_9 g-flex-middle g-px-10">
                            <q class="u-quote-v1 g-flex-middle-item g-color-white g-font-weight-700 g-font-size-16 text-uppercase">changing
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 g-mb-50">
                    {{-- Testimonials --}}
                    <blockquote class="lead u-blockquote-v1 rounded g-pl-60 g-pr-30 g-py-30 g-mb-40">Dear Htmlstream
                        team, I just bought the Unify template some weeks ago. The template is really nice and offers
                        quite a large set of options.
                    </blockquote>
                    <div class="media">
                        <img class="d-flex align-self-center rounded-circle g-width-60 g-brd-around g-brd-3 g-brd-white mr-3"
                ...
                <div class="col-md-6 g-mb-50">
                    {{-- Testimonials --}}
                    <blockquote class="lead u-blockquote-v1 rounded g-pl-60 g-pr-30 g-py-30 g-mb-40">Hi there purchased
                        a couple of days ago and the site looks great, big thanks to the htmlstream guys, they gave me
                        some great help with some fiddly setup issues.
                    </blockquote>
                    <div class="media">
                        <img class="d-flex align-self-center rounded-circle g-width-60 g-brd-around g-brd-3 g-brd-white mr-3"
